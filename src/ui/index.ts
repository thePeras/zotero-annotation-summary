...
function renderAnnotations() {
  ...
  pageResults.forEach((a: any, idx: number) => {
    ...
    if (idx === 0) {
      ...
      (selectAllBtn as any).style.right = "12px";
      (selectAllBtn as any).style.bottom = "10px";
      (selectAllBtn as any).style.display = "none";
      (selectAllBtn as any).style.zIndex = 10;
      (selectAllBtn as any).style.padding = "4px 10px";
      (selectAllBtn as any).style.borderRadius = "4px";
      (selectAllBtn as any).style.background = "#5680c3";
      (selectAllBtn as any).style.color = "#fff";
      (selectAllBtn as any).style.border = "none";
      (selectAllBtn as any).style.fontWeight = "500";
      (selectAllBtn as any).style.cursor = "pointer";
      (selectAllBtn as any).style.fontSize = "0.85rem";
...
function renderBatchTagSuggestions(filter = "") {
  ...
  suggestions.forEach((tag: any) => {
    ...
    (item as any).style.padding = "6px 10px";
    (item as any).style.cursor = "pointer";
    (item as any).style.fontSize = "0.9rem";
    ...
    item.addEventListener("mouseenter", () => {
      (item as any).style.backgroundColor = "#f0f0f0";
    });
...
function openColorMenuForAnnotation(containerEl: HTMLElement, itemID: number) {
  ...
  if (colors.length === 0) {
    ...
    (none as any).style.fontSize = "0.85rem";
